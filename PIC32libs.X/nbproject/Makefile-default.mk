...
OUTPUT_SUFFIX=a
DEBUGGABLE_SUFFIX=
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/PIC32libs.X.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=SPI.c I2C_master_noint.c ILI9163C.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/SPI.o ${OBJECTDIR}/I2C_master_noint.o ${OBJECTDIR}/ILI9163C.o
POSSIBLE_DEPFILES=${OBJECTDIR}/SPI.o.d ${OBJECTDIR}/I2C_master_noint.o.d ${OBJECTDIR}/ILI9163C.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/SPI.o ${OBJECTDIR}/I2C_master_noint.o ${OBJECTDIR}/ILI9163C.o

# Source Files
SOURCEFILES=SPI.c I2C_master_noint.c ILI9163C.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/PIC32libs.X.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/PIC32libs.X.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_AR} $(MP_EXTRA_AR_PRE) r dist/${CND_CONF}/${IMAGE_TYPE}/PIC32libs.X.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}    
else
dist/${CND_CONF}/${IMAGE_TYPE}/PIC32libs.X.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_AR} $(MP_EXTRA_AR_PRE) r dist/${CND_CONF}/${IMAGE_TYPE}/PIC32libs.X.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}    
